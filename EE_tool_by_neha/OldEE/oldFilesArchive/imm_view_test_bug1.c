...
int accessattribute1(SaImmHandleT immHandle,char *SUname,char attribute[maxsize]);
void reset();
void reset2();
char *firstSIofSG(SaImmHandleT immHandle,char rootName[maxsize],char SIname[maxsize]);
...
void swapsi1(SaImmHandleT immHandle,SaImmAdminOperationIdT operationId,SaNameT objectName)
{
 ...
 SaImmAdminOwnerNameT adminOwnerName = create_adminOwnerName(basename(g_argv1[0]));
// SaNameT objectName;
 const SaNameT *objectNames[] = { &objectName, NULL };
 //char s[] = "safSi=AmfDemo,safApp=AmfDemo1";
 //SaImmAdminOperationIdT operationId = 7;
...
void on_button16_clicked(GtkWidget *button, gpointer user_data)
{
int rc,i;
SaAisErrorT error;
error = saImmOmInitialize( &immHandle, NULL, &immVersion);
   ...
   strcpy(objectnameSG1.value,"safSg=AmfDemo,safApp=AmfDemo1");
   objectnameSG1.length = strlen(objectnameSG1.value);
   swapsi1(immHandle,1,objectnameSG1); //UNLOCK SG
   reset();
   reset2();
    for(i=0;i<3;i++)
    {
...
void on_button17_clicked(GtkWidget *button, gpointer user_data)
{
  // printf("\nI got a call2");
   int rc,i;
SaAisErrorT error;
	...
	if (error != SA_AIS_OK) {
       ...
       if (error == SA_AIS_OK)
         // printf("%c[1;31m\nIMM handle gained\n",27);
          printf("%c[0m",27);
   SaNameT objectnameSG1;
   strcpy(objectnameSG1.value,"safSg=AmfDemo,safApp=AmfDemo2");
   objectnameSG1.length = strlen(objectnameSG1.value);
   swapsi1(immHandle,1,objectnameSG1); //UNLOCK SG
   reset();
   reset2();
...
void on_button18_clicked(GtkWidget *button, gpointer user_data)
{
  // printf("\nI got a call3");
 int rc,i;
SaAisErrorT error;
...
void on_SI1Inc_clicked(GtkWidget *button, gpointer user_data)
{

     int result1,flag_set =0,i;
     strcpy(nameSI,"safSi=AmfDemo,safApp=AmfDemo1");
     printf("\n THe si is %s",nameSI);
     flag_set =3;
     elasticityact =1;
     buffer2_manager=0;
     result1= elasticity_engine_main(argc1,(char *)argv1);    
    printf("\n the result is %d and buffer2_manager %d",result1,buffer2_manager);
     reset();
   ...
   if(result1 == 1)
  {
         gtk_label_set_text(GTK_LABEL(display1),"Elasticity Action Successful");
  }
  if(result1 == 2)
  {
          gtk_label_set_text(GTK_LABEL(display1),"This is minimum configuration "); 
  }
  if(result1 == 3)
  {
          gtk_label_set_text(GTK_LABEL(display1),"Please Configure Nodes in cluster");
  }



  if (buffer2_manager==1)
  {
         gtk_label_set_text(GTK_LABEL(display2),"Enough SUs in the Buffer"); 
  }
 if (buffer2_manager==2)
  {
         gtk_label_set_text(GTK_LABEL(display2),"Please Configure Nodes in cluster to manage futher workload chage"); 
  }
...
void on_SI1Dec_clicked(GtkWidget *button, gpointer user_data)
{
...
void on_SI2Inc_clicked(GtkWidget *button, gpointer user_data)
{

   //printf("\n was clicked");
     int result1,flag_set =0,i;
     strcpy(nameSI,"safSi=AmfDemoSi,safApp=AmfDemo2");
     flag_set =3;
     elasticityact =1;
     buffer2_manager=0;
     result1= elasticity_engine_main(argc1,(char *)argv1);    
...
void on_SI2Dec_clicked(GtkWidget *button, gpointer user_data)
{
...
void on_SI3Inc_clicked(GtkWidget *button, gpointer user_data)
{

  // printf("\n was clicked");
   int result1,flag_set =0,i;
   strcpy(nameSI,"safSi=AmfDemoSi1,safApp=AmfDemo2");
     flag_set =3;
     elasticityact =1;
     buffer2_manager=0;
     result1= elasticity_engine_main(argc1,(char *)argv1);    
...
void on_SI3Dec_clicked(GtkWidget *button, gpointer user_data)
{
...
{  int i;
  ...
  // printf("\n This is reset");
   ...
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI1SU1), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI1SU1), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI1SU2), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI1SU2), "label", " ", NULL); 
   
   
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI1SU3), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI1SU3), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI1SU4), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI1SU4), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI1SU5), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI1SU5), "label", " ", NULL); 

 

    gtk_label_set_text(GTK_LABEL(display1)," ");
    gtk_label_set_text(GTK_LABEL(display2)," ");
...
void reset2()
{
  ...
  // printf("\n This is reset2");
   ...
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI2SU1), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI2SU1), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI2SU2), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI2SU2), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI2SU3), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI2SU3), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI2SU4), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI2SU4), "label", " ", NULL);
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI2SU5), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI2SU5), "label", " ", NULL);

   gtk_widget_modify_bg (GTK_WIDGET(buttonSI3SU1), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI3SU1), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI3SU2), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI3SU2), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI3SU3), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI3SU3), "label", " ", NULL); 
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI3SU4), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI3SU4), "label", " ", NULL);
   gtk_widget_modify_bg (GTK_WIDGET(buttonSI3SU5), GTK_STATE_NORMAL, NULL);
   gtk_object_set(GTK_OBJECT(buttonSI3SU5), "label", " ", NULL);
                ...
                if (error == SA_AIS_OK)
                {
                    ...
                    if(ch == NULL)
                      ...
                      else
                      {
                               ...
                               strcpy(attribute,"saAmfSISUHAState");
                               assignmentflag = accessattribute1(immHandle,objectName1.value,attribute);
                              // printf("\nAssignmentsflag %d",assignmentflag);
                             ...
                             nodecheck=strcmp(nodename,"safAmfNode=PL-5,safAmfCluster=myAmfCluster");
          					...
          					gtk_object_set(GTK_OBJECT(buttonSI1SU3), "label", "Active Assg SI1", NULL); 
                                          ...
                                          {    
                                             if(assignmentflag == 1)
                                              {
                                               gtk_widget_modify_bg (GTK_WIDGET(buttonSI2SU3), GTK_STATE_NORMAL, &color3);
...
char *firstSIofSG(SaImmHandleT immHandle,char rootName[maxsize],char SIname[maxsize])
{
 ...
 SaNameT objectNameSG1;
 strncpy((char *)objectNameSG1.value,rootName , SA_MAX_NAME_LENGTH);
 objectNameSG1.length = strlen(objectNameSG1.value);
 //SaImmHandleT immHandle;
 ...
 int rc = EXIT_SUCCESS, no_SIs=0,flag;
  SaAisErrorT error;
 SaNameT objectName;
 SaImmAttrValuesT_2 **attributes;
											...
											printf("error8 - saImmOmSearchNext_2 FAILED: %d\n", error);
						 					...
						 					if (error == SA_AIS_OK)
							   					...
							   					no_SIs= no_SIs + 1;
                                               	                                                if( no_SIs==1)
                                                                                                {
                                                                                                  // printf("\nthe SI is %s",objectName.value);
                                                                                                   strcpy((char *)SIname, objectName.value);
                                                                                                   return SIname;
                                                                                                }
...
// printf("\n 4");
 ...
 SaImmAttrNameT  attributeNames[] ={"saAmfSISUHAState",NULL};
 //const SaNameT rootName =  objectnameSI;
 SaAisErrorT error;
 SaNameT objectName1;
 strncpy((char *)objectName1.value,SUname, SA_MAX_NAME_LENGTH);
					...
					error = saImmOmAccessorInitialize( immHandle, &accessorHandle);
       		   	      	 ...
       		   	      	 if (error == SA_AIS_OK)
   		    		{
       					...
       					if(error == SA_AIS_OK)
       					{
	                                  ...
	                                  //                            		printf("\nRank!!!");
										SaImmAttrValueT *attrValue = attributes[0]->attrValues[0];
                                                                    		assignmentflag = *((SaUint32T *)attrValue);
...
void change_rank(SaImmHandleT immHandle,SaNameT objectName,int SURank,char *argv[])
{
  //printf("\nchange_rank");
   printf("\n Change SU %s rank to %d",objectName.value,SURank);
   SaAisErrorT error;
   SaImmAccessorHandleT accessorHandle;
   SaImmSearchHandleT searchHandle;
...
*/
     attributeNames[0] = "saAmfSGNumPrefInsericeSUs";
   attributeNames[1] = NULL;
   SaNameT *objectnameSG2;
...
totalSUs = num_SUofSG(immHandle,objectnameSG1);
uninstantiated = totalSUs - uninstantiated;
error = saImmOmAccessorFinalize(accessorHandleX);
 ...
 //if(uninstantiated > buffer2)             //sweden demo
 if(uninstantiated >= buffer2)
 {
            //  gtk_label_set_text(GTK_LABEL(display2),"Enough SUs in Buffers");
                buffer2_manager=1;
 }
 else
 {
...
//printf("\n1");
					 			   ...
					 			   if (SA_AIS_OK != error) {
										...
										//"Calculating the total required capacity i.e summing up the SI assignments");
                                                     ...
                                                     {            
                                                                   buffer2_manager=2;
                                                                  printf("\n the buffer manager is %d",buffer2_manager);
                                                                  printf("\n Need to increase Nodes"); 
                                                                  // gtk_label_set_text(GTK_LABEL(display2),"Need to increase number of Nodes");
                                                                   buffer2_manager=2;
                                                     }
                                                     else
                                                     {
	...
	printf("%c[0m",27);
        goto loop30;
               ...
               else
               {
                        ...
                        printf("%c[0m",27);
                        buffer2_manager=2;
                        printf("\n the buffer_manager %d",buffer2_manager);
                       // gtk_label_set_text(GTK_LABEL(display2),"Please Configure Nodes in cluster");
               }
...
// objectnameSI.length= strlen(nameSI);
 ...
 if (error != SA_AIS_OK) {
	...
	error= saImmOmAccessorGet_2(accessorHandle, &objectnameSG1, attributeNamesSg, &attributesSG);
	if (error ==SA_AIS_OK)
	{
...
//printf("\n<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<Initializing the activetemp and standbytemp>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
  error = saImmOmAccessorInitialize( immHandle, &accessorHandle60);
 if (error != SA_AIS_OK) {
                printf("error - saImmOmAccessorInitialize FAILED:%d",error);
                rc= EXIT_FAILURE;
                      }
  ...
  //     printf("\nWe got the accessor handle to access SG <3<3<3\n");
      	...
      	error= saImmOmAccessorGet_2(accessorHandle60, &objectnameSG1, attributeNamesSgtype, &attributesSGtype);
	if (error !=SA_AIS_OK)
	{
	 printf("\n%d",error);
         rc= EXIT_FAILURE;
...
//>>>
 error = saImmOmAccessorInitialize( immHandle, &accessorHandle62);
 if (error != SA_AIS_OK) {
                printf("error - saImmOmAccessorInitialize FAILED:%d",error);
                rc= EXIT_FAILURE;
                      }
...
error= saImmOmAccessorGet_2(accessorHandle62, &objectnamesgtype1, attributeNamesSgtype1, &attributesSGtype1);
	...
	if (SA_AIS_OK != error) {
		...
		//printf("error - saImmOmSearchInitialize_2 FAILED");
		   ...
		   //printf("error - saImmOmSearchInitialize :%d\n",error);
				...
				error = saImmOmSearchNext_2(searchHandle63, &objectnameSGSUs, &attributesSGSUs);
                		if (error != SA_AIS_OK && error != SA_AIS_ERR_NOT_EXIST)
				{
				...
				if (error == SA_AIS_OK)
                 		 {     
 			       		...
 			       		error = saImmOmAccessorInitialize( immHandle, &accessorHandle15);
 			       		if (error != SA_AIS_OK) {
                	       			printf("error - saImmOmAccessorInitialize FAILED:%d",error);
                	       			rc= EXIT_FAILURE;
                      			}
					...
					//	printf("%s\n", objectsuname.value);
                                 		...
                                 		error= saImmOmAccessorGet_2(accessorHandle15, &objectsuname, attributeNamesSUc, &attributesassignmentact);
                                        	if (error !=SA_AIS_OK)
                                        	{
                                               		printf("\nerror:%d",error);
                                        	}
					...
					//		printf("\nit is active\n");
 							 	 ...
 							 	 error = saImmOmAccessorInitialize( immHandle, &accessorHandle15);
                       						if (error != SA_AIS_OK)
		   						{	
                							printf("error16 - saImmOmAccessorInitialize FAILED:%d",error);
                							rc= EXIT_FAILURE;
                    						}
       		   						if (error == SA_AIS_OK)
   	           						{       
									...
									//&attributesSUrank);     
									error= saImmOmAccessorGet_2(accessorHandle15, &objectsuname, attributeNamesSUrank,  
    							 ...
    							 error = saImmOmAccessorInitialize( immHandle, &accessorHandle15);
		   						...
		   						{	
                      				...
                      				//			printf("\nWe got the accessor handle to access SU s stanfby !!\n");
                                                        	        error= saImmOmAccessorGet_2(accessorHandle15, &objectsuname, attributeNamesSUc1,   		
									&attributesSUc);        
                                       					if (error ==SA_AIS_OK)
                                                                        {
				...
				if (error == SA_AIS_OK)
       			       ...
       			       if (error == SA_AIS_OK)
   				{
					...
					//printf("%s\n", objectsuname.value);
                                 	...
                                 	error= saImmOmAccessorGet_2(accessorHandle15, &objectsuname, attributeNamesSUc1, &attributesassignmentstd);
                                        if (error !=SA_AIS_OK)
                                        {
                                               printf("\nerror:%d",error);
                                        }
...
//"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
					     ...
					     if (error != SA_AIS_OK) 
	   				     ...
	   				     {
	       					//printf("\n<3<3<3\n"); 
	              			       error= saImmOmAccessorGet_2(accessorHandle15, &objectsuname, attributeNamesSU, &attributesSUnode);
	      				       if (error ==SA_AIS_OK)
	                                       {
	        			...
	        			{        c=0;
						 actass1=0,stdass1=0;
							...
							error = saImmOmSearchNext_2(searchHandle21, &objectsu2, &attributessu2);
							if (error != SA_AIS_OK && error != SA_AIS_ERR_NOT_EXIST) {
                					printf("error22 - saImmOmSearchNext_2 FAILED: %d\n", error);
                				        ...
                				        if(error == SA_AIS_ERR_NOT_EXIST)
             							...
             							error = saImmOmAccessorInitialize( immHandle, &accessorHandle23);
                       						if (error != SA_AIS_OK)
		   						{	
                							printf("error23 - saImmOmAccessorInitialize FAILED:%d",error);
                							rc= EXIT_FAILURE;
                    						}
       		   						if (error == SA_AIS_OK)
   	           						{       
                      							...
                      							//printf("\nWe got the accessor handle to access SU on the node !!\n");
                                                        	        error= saImmOmAccessorGet_2(accessorHandle23, &objectsu2, attributeNamesSUc,   		
									&attributesSUc);        
                                       					if (error ==SA_AIS_OK)
                                                                        {
										...
										actass1 = actass1 + *((SaUint32T *)attrValuec1);
                       						...
                       						if (error != SA_AIS_OK)
		   						{	
                							printf("error25 - saImmOmAccessorInitialize FAILED:%d",error);
                							rc= EXIT_FAILURE;
                    						}
       		   						if (error == SA_AIS_OK)
   	           						{       
                      						...
                      						//	printf("\nWe got the accessor handle to access SU on the node !!\n");
                                                        	        error= saImmOmAccessorGet_2(accessorHandle23, &objectsu2, attributeNamesSUc1,   		
									&attributesSUc);        
                                       					if (error ==SA_AIS_OK)
                                                                        {
		   						...
		   						{	
   	           						...
   	           						{       
                      							...
                      							//printf("\nWe got the accessor handle to access SU for rank !!\n");
                                                        	        //error17= saImmOmAccessorGet_2(accessorHandle15, &objectsuname, attributeNamesSUrank,   		
									//&attributesSUrank);     
									error= saImmOmAccessorGet_2(accessorHandle15, &objectsu2, attributeNamesSUrank,  
							...
							error = saImmOmAccessorInitialize( immHandle, &accessorHandle15);
		   					...
		   					{	
     		   					...
     		   					if (error == SA_AIS_OK)
   	           					{            
                      						//printf("\nWe got the accessor handle to access SU for rank !!\n");   
								error= saImmOmAccessorGet_2(accessorHandle15, &objectsu2,
...
//
				...
				//}
                                   //acces the host node
                                   //compare the assignments
                                     printf("Comparing the assignments handled the SU hosted on this Node..\n ");
                                     if(activet > actass1+assignmentactFinal)
                                     {
                                          printf("This SUs hosted on this Node handle least number of assignments hence this node has maximum capacity\n");
 				         activet = actass1+assignmentactFinal;
...
int Rankchange_npm(SaImmHandleT immHandle,SaNameT objectnameSG1,char *argv[])
{
printf("\nThe ranking");
SaAisErrorT error;
int no_SUs,i,flag=1,SURank,rc = EXIT_SUCCESS;;
SGSU listSGSU[15];
SaImmAttrValuesT_2 **attributes;
SaImmAccessorHandleT accessorHandle;
SaImmAttrNameT  attributeNames[] ={"saAmfSURank",NULL};



no_SUs=create_listSGSU(immHandle,objectnameSG1,listSGSU);
change_rankSI_increase(immHandle,listSGSU,no_SUs); 
for(i=0;i<=no_SUs || flag!=0;i++)
{
error = saImmOmAccessorInitialize( immHandle, &accessorHandle);
								...
								error= saImmOmAccessorGet_2(accessorHandle, &listSGSU[i].SUName, attributeNames,&attributes);  
									if (error ==SA_AIS_OK)
                                                                        {
	                          
										SaImmAttrValueT *attrValue = attributes[0]->attrValues[0];
                                                                    		
										SURank = *((SaUint32T *)attrValue);
               						   			error = saImmOmAccessorFinalize(accessorHandle);
                                                                                
					               	                }
                                                                        
   		                                        	 }
//printf("\nThe calculated rank %d and the set rank %d",listSGSU[i].rank,SURank);
if(listSGSU[i].rank!=SURank)
{
flag= 0;
}
       		    ...
       		    if (error == SA_AIS_OK)
   		    {
	 			...
	 			printf("error - saImmOmAccessorGet_2 FAILED:%d\n",error);					
       			...
       			if(error == SA_AIS_OK)
       			{
                                 ...
                                 if(noSIassgactSUF == 1)                  // Stokham Sweden Demo
                                           {
                                                noSIassgstdSUF =1;  
                                           }
      			}
       			...
       			if(error == SA_AIS_OK)
       			{
	                                  ...
	                                  //                            		printf("\nRank!!!");
										...
										noSIassgstdSUF = *((SaUint32T *)attrValue);
               						   			error = saImmOmAccessorFinalize(accessorHandle);
/*
                                           if(noSIassgstdSUF == 1)                  // Stokham Sweden Demo
                                           {
                                                noSIassgstdSUF =100;  
                                           }
*/
...
strncpy((char *)objectsity.value, pointer1, SA_MAX_NAME_LENGTH);
objectsity.length= strlen(objectsity.value);
printf("The SI .. type is %s \n",objectsity.value);
*/
...
//**********************************************************************TRY TO CHANGE RANK FIRST THEN CLUSTER LEVEL *************************************************************
   clusterlevel= Rankchange_npm(immHandle,objectnameSG1,argv);
if(clusterlevel==1)
{
...
int rank=1,count=0,ch,i;
  ...
  while (rank <= no_SUs )
  {
     ...
     for(i=0;i <=no_SUs;i++)
     {
//printf("\nSU name %s assign %d",listSGSU[i].SUName.value,listSGSU[i].CurrentActiveSIs);
ch = check_array_rankedSUs(array_rankedSUs,listSGSU[i].SUName.value,count);
...
int no_SUs,i;
 SaImmAdminOwnerNameT adminOwnerName = create_adminOwnerName(basename(argv[0]));
int len1,len2,len3,cntr1,cntr2,flag=0,noSIassg,noassgactSUs,noSIassgactSU,noSIassgstdSU,noassgSUs,maxactSIsperSU,no_SIs,activeSIssum,activeSIs,noSIassgactSUF,noSIassgstdSUF,noassginsSUs,noactassgSUs,noassgstdSUs,maxstdSIsperSU,DefStandbyNumCSIs;
int noSIassgcurractSU,flag1=0,DefActiveNumCSIs,noSIassgcurrstdSU;
loop75:
attributeNames[0]="saAmfSGMaxActiveSIsperSU";
   attributeNames[1]=NULL;
...
//****************************************Start FUNCTION CALL TO CHANGE RANK OF SUs *************************************************************//

//change_SU_ranks (immHandle,objectnameSG1,argv);
no_SUs=create_listSGSU(immHandle,objectnameSG1,listSGSU);
...
//****************************************End FUNCTION CALL TO CHANGE RANK OF SUs *************************************************************//
...
if(result ==2)
{
  ...
  if(i<=counter)
  {
   ...
   objectname.length= strlen(objectname.value);
   printf("\n the sg in cluster %s",objectname.value);
   //Initilize the SI name
   SIname = firstSIofSG(immHandle,objectname.value,SIName);
   
   strncpy((char *)objectnameSI.value, SIname, SA_MAX_NAME_LENGTH);
   objectnameSI.length= strlen(objectnameSI.value);
   printf("\nThe SI name is :%s",objectnameSI.value);
   //Initilize the SI name
...
int main (int argc, char *argv[])
{
        GtkBuilder              *builder;
        GtkWidget               *window1;
        GtkWidget               *buttonSI1, *buttonSI2, *buttonSI3;
        GtkWidget               *SI1Inc, *SI2Inc, *SI3Inc, *SI1Dec, *SI2Dec, *SI3Dec;
   ...
   strcpy(argv1, argv[0]);
        ...
        buttonSI1 = GTK_WIDGET (gtk_builder_get_object (builder,"button16"));
        buttonSI2 = GTK_WIDGET (gtk_builder_get_object (builder,"button17"));
        buttonSI3 = GTK_WIDGET (gtk_builder_get_object (builder,"button18"));



       //Assignments
       buttonSI1SU1 = GTK_WIDGET (gtk_builder_get_object (builder,"SI1SU1"));
       buttonSI1SU2 = GTK_WIDGET (gtk_builder_get_object (builder,"SI1SU2"));
       buttonSI1SU3 = GTK_WIDGET (gtk_builder_get_object (builder,"SI1SU3"));
       buttonSI1SU4 = GTK_WIDGET (gtk_builder_get_object (builder,"SI1SU4"));
       buttonSI1SU5 = GTK_WIDGET (gtk_builder_get_object (builder,"SI1SU5"));

       buttonSI2SU1 = GTK_WIDGET (gtk_builder_get_object (builder,"SI2SU1"));
       buttonSI2SU2 = GTK_WIDGET (gtk_builder_get_object (builder,"SI2SU2"));
       buttonSI2SU3 = GTK_WIDGET (gtk_builder_get_object (builder,"SI2SU3"));
       buttonSI2SU4 = GTK_WIDGET (gtk_builder_get_object (builder,"SI2SU4"));
       buttonSI2SU5 = GTK_WIDGET (gtk_builder_get_object (builder,"SI2SU5"));

       buttonSI3SU1 = GTK_WIDGET (gtk_builder_get_object (builder,"SI3SU1"));
       buttonSI3SU2 = GTK_WIDGET (gtk_builder_get_object (builder,"SI3SU2"));
       buttonSI3SU3 = GTK_WIDGET (gtk_builder_get_object (builder,"SI3SU3"));
       buttonSI3SU4 = GTK_WIDGET (gtk_builder_get_object (builder,"SI3SU4"));
       buttonSI3SU5 = GTK_WIDGET (gtk_builder_get_object (builder,"SI3SU5")); 


       SI1Inc = GTK_WIDGET (gtk_builder_get_object (builder,"SI1Inc")); 
       SI1Dec = GTK_WIDGET (gtk_builder_get_object (builder,"SI1Dec")); 
      
       SI2Inc = GTK_WIDGET (gtk_builder_get_object (builder,"SI2Inc"));   
       SI2Dec = GTK_WIDGET (gtk_builder_get_object (builder,"SI2Dec"));

       SI3Inc = GTK_WIDGET (gtk_builder_get_object (builder,"SI3Inc"));   
       SI3Dec = GTK_WIDGET (gtk_builder_get_object (builder,"SI3Dec"));
      
       display1 = GTK_WIDGET (gtk_builder_get_object (builder,"label6"));  
       display2 = GTK_WIDGET (gtk_builder_get_object (builder,"label7")); 
        ...
        gtk_widget_modify_bg (GTK_WIDGET(buttonSI1), GTK_STATE_NORMAL, &color1);
        gtk_widget_modify_bg (GTK_WIDGET(buttonSI2), GTK_STATE_NORMAL, &color3);
        gtk_widget_modify_bg (GTK_WIDGET(buttonSI3), GTK_STATE_NORMAL, &color3);

        gtk_widget_modify_bg (GTK_WIDGET(SI1Inc), GTK_STATE_NORMAL, &color1);
        gtk_widget_modify_bg (GTK_WIDGET(SI1Dec), GTK_STATE_NORMAL, &color1);
 
        gtk_widget_modify_bg (GTK_WIDGET(SI2Inc), GTK_STATE_NORMAL, &color3);
        gtk_widget_modify_bg (GTK_WIDGET(SI2Dec), GTK_STATE_NORMAL, &color3);

        gtk_widget_modify_bg (GTK_WIDGET(SI3Inc), GTK_STATE_NORMAL, &color3);
        gtk_widget_modify_bg (GTK_WIDGET(SI3Dec), GTK_STATE_NORMAL, &color3);
