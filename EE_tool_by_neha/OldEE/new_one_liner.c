...
SaAisErrorT error;
int i,flag=1,SURank,rc = EXIT_SUCCESS;
...
int i,j, result1=0;
  ...
  switch(choice){
    ...
    case 2:
      ...
      break;
    default:
      printf("Invalid elasticity action provided\n");
      exit(22);
  }
  strncpy(nameSI, SIname, SA_MAX_NAME_LENGTH);
  flag_set=3;               //SIGNAL FROM MONITOR
  buffer2_manager=0;
  result1 = elasticity_engine_main(argc1,(char *)argv1);
  ...
  switch(result1){
    case 1:
      printf("Elasticity Engine: Elasticity Action Successful.\n");
      break;
    case 2:
      printf("Elasticity Engine: This is minimum configuration.\n");
      break;
    case 3:
      printf("Elasticity Engine: Please Configure Nodes in cluster\n");
      break;
    default:
      printf("Elasticity Engine: Something went wrong with 'elasticity_engine_main' call, invalid output:%d.\n", result1);
  }

  switch(buffer2_manager){
    case 1:
      printf("Buffer status: Enough SUs in the Buffer\n");
      break;
    case 2:
      printf("Buffer Status: Please Configure Nodes in cluster to manage futher workload chage\n");
      break;
  }
