...
gtk_window_set_title(GTK_WINDOW(win), "AMF Runtime Configuration");
gtk_container_set_border_width (GTK_CONTAINER (win), 0);
//gtk_widget_set_size(win, 300, 300);
...
elasticityresultlabel1 = gtk_label_new (" ");
//gtk_container_add(GTK_CONTAINER(fixed),  elasticityresultlabel1);
gtk_fixed_put(GTK_FIXED(fixed), elasticityresultlabel1, 0, 0);
