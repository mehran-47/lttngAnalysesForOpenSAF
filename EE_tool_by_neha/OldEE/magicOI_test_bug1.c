...
int i=0,found=0;
 ...
 char *ptr1;
 SaNameT object,objectComp;
  char CompType[SA_MAX_NAME_LENGTH],assclass[SA_MAX_NAME_LENGTH];

 int c,foundsafSupported=0;
 SaAisErrorT errorc;
...
/*///find the component type /////////This code is to generate CompType*************** 
ptr = strstr(objectnameSI.value,"safApp");
strncpy((char *)rootName.value,ptr , SA_MAX_NAME_LENGTH);
 rootName.length = strlen((char *)rootName.value);
