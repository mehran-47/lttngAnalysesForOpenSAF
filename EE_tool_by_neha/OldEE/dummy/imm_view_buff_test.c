...
void change_SU_ranks (SaImmHandleT immHandle,SaNameT objectnameSG1)
{
  
    SaNameT rootName = { 0, "" };
  int noofSU=0, SUrank=1; 
 noofSU= num_SUofSG(immHandle,objectnameSG1);
...
printf("\n ****************************************I got a call to find no of SUs");
change_SU_ranks (immHandle,objectnameSG1);
