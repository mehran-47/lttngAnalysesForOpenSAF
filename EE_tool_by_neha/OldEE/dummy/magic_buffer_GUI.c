...
void on_button1_clicked(GtkWidget *button, gpointer user_data)
{
     ...
     gchar *text;
    gchar d_string[256];
    strcpy(d_string,"Elasticity Action Successful");
  ...
  if(result1 == 2)
  {
          gtk_label_set_text(GTK_LABEL(display1),"Elasticity Action at Cluster Level"); 
  }
  if(result1 == 3)
  {
...
int main (int argc, char *argv[])
{
   ...
   strcpy(argv1, argv[0]);
        ...
        display1 = GTK_WIDGET (gtk_builder_get_object (builder,"label2"));  
        display2 = GTK_WIDGET (gtk_builder_get_object (builder,"label3"));  
