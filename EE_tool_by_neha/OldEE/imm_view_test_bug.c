...
int check_otherSUs_on_node(SaImmHandleT immhandle,SaNameT objectname)
{
// printf("\n I am gonna fo it");
 SaAisErrorT error;
 SaImmSearchHandleT searchHandle;
...
printf("\n the active SIs sum is %d and %d", activeSisSum ,standbySisSum);
  						if(activeSisSum >2 || standbySisSum > 2)
                                                  {     
                                                        //foundsu = 1;
                                                       // printf("\nWe got the Sus to change the rank\n");
                                                        return 1;
...
void change_SU_ranks (SaImmHandleT immHandle,SaNameT objectnameSG1,char *argv[])
{

    SaNameT rootName = { 0, "" };

  int noofSU=0, SUrank=1,SU_ASSIGNED; 
	...
	do {
		...
		if (error == SA_AIS_OK)
			  ...
			  // printf("\n **SU** : %s\n ", objectName.value);
                          ...
                          SU_ASSIGNED = check_otherSUs_on_node(immHandle,objectName);
                          if (SU_ASSIGNED == 1)
                          {
                                  // printf("\n Add a CCB TO change rank");
                                   printf("\n Add CCB to change %s rank to %d",objectName.value,SUrank);
